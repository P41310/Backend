        ...
        <table class="table table-bordered" cellspacing="0" rules="all" id="ContentPlaceHolder1_GridProduccion">
            ...
            <tbody id="detalle">
                ...
                ?>
                    ...
                    <!--Se insertar nuevamente <?php  ?>, por que recordemos que en la linea
    ...
    <script>
        ...
        function mandarDatos() {
            $.ajax({
                ...
                url: "buscar.php?buscarTurno=" + buscarTurno.value + "&buscarLinea=" + buscarLinea.value + "&buscarFechaInicio=" + buscarFechaInicio.value + "&buscarFechaFin=" + buscarFechaFin.value, //usamos el archivo buscar.php enviando por la url el valor ingresao en el campo buscar
                data: {},
